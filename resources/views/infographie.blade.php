      ...
      <div class="col-md-10 col-lg-8">
        <div class="p-b-20">
          ...
          <div class="tab01 p-b-20">
                          ...
                          <div >
                              <img width="685" height="400" src="{{URL::asset('public/images/infographie.jpg')}}">
                          </div>
                           <!--Space-->
            ...
            <div>
              ...
              <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                Vous êtes passionné par les communications imprimées et électroniques?
                Rejoignez-nous et découvrez les logiciels de mise en page, d’illustration et de traitement d’images
                les plus connus dans l’industrie. À l’aide des meilleurs équipements actuels sur le marché, devenez le
                créateur des prochaines publicités les plus « in » EN  Mauritanie.
              </p>
              ...
              <!-- Item post -->
                ...
                <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                  Baccalauréat ou niveau BAC.
                </p>
                <h1 class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;"> <i class="fa fa-arrow-right"></i>
                  <strong>DEBOUCHES :</strong>
                </h1>
                <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                  Directeur artistique, chef de publicité, Directeur d’agence de publicité, Infographiste.
                </p>
                ...
                <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                  Brevet de technitient en Infographie.
                </p>
                <h1 class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;"> <i class="fa fa-arrow-right"></i>
