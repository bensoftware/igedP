...
<section class="hero-wrap hero-wrap-2" style="background-image: url({{URL::asset('public/images/francais.jpg')}});">
<div class="overlay"></div>
<div class="container">
  <div class="row no-gutters slider-text align-items-center justify-content-center">
  <div class="col-md-9 ftco-animate text-center">
      <h1 class="mb-2 bread">COURS DE LANGUE</h1>
    <h1 class="mb-2 bread">FRANÇAISE</h1>
  </div>
</div>
</section>
  ...
  <section class="ftco-section">
		<div class="container-fluid px-4">
			<div class="row">
        <h1><b>SESSION DE FORMATION : FRANÇAIS MODULE DÉBUTANT (GROUPE)
        8 Juillet 2020 À 17 H 30 MIN - 19 H 00 MIN </b> </h1></br></br>
                <p></p>
          <p>– Développer ses aptitudes à communiquer en français, vaincre ses appréhensions et acquérir des connaissances grammaticales et lexicales de base</p> </br>
