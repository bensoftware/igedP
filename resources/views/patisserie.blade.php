      ...
      <div class="col-md-10 col-lg-8">
        <div class="p-b-20">
          ...
          <div class="tab01 p-b-20">
                          ...
                          <div >
                              <img width="685" height="400" src="{{URL::asset('public/images/patisserie.jpg')}}">
                          </div>
                           <!--Space-->
            ...
            <div>
              ...
              <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                Le  Pâtissier choisit les matières premières et les techniques de confection des produits de boulangerie pâtisserie,
                 les méthodes de travail adéquates, efficaces et sécuritaires, développe l’habitude
                de l’auto-évaluation de ses produits, l’autonomie, le sens des responsabilités, la créativité et l’esthétique.
              </p>
              ...
              <!-- Item post -->
                ...
                <h1 class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;"> <i class="fa fa-arrow-right"></i>
                  <strong>DUREEE DE LA FORMATION :</strong>
                                  ...
                                  <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                  Le contenu de la formation CAP Pâtissierse/Boulangerie fait en 1 ou 2 ans au choix (sous certaines conditions).
      ...
      <div class="col-md-10 col-lg-4">
        <div class="p-l-10 p-rl-0-sr991 p-b-20">
                  ...
                  <div class="fb-page fb_iframe_widget" data-href="https://web.facebook.com/InstitutGED/"
                     ...
                     <span style="vertical-align: bottom; width: 300px; height: 400px;">
