          ...
          <div class="tab01 p-b-20">
            ...
            <div>
                              <!-- Item post -->
                                  ...
                                  Offrant des formations professionnelles dans le domaine de l'informatique,Logistique et des sciences de gestion, l’IGED délivre
                                  des diplômes nationaux et internationaux.
                                  </p>

                                  <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;">
                                  Pour insuffler sa dynamique de croissance, incarnée par ambitions futuristes, l’IGED mène couramment des actions de formation
                                  pluridisciplinaires au profit des non bacheliers, bacheliers et des professionnels.
                                  Les différentes formations qui y sont dispensées sont sanctionnées par l’un des diplômes suivants : CAP,BT,BTS et VAE.
                                  </p>

                                  <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;">
                                   L’administration des cours est assurée par des enseignants pluridisciplinaires et des professionnels de haut niveau. Outre les programmes
                                   officiels de formation,
                                   les étudiants suivent d’autres formations (logiciels de gestion, traitement d’images etc.) sanctionnées par des attestations.
                                  </p>
                          </div>
          </div>
        </div>
