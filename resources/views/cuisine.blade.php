        ...
        <div class="p-b-20">
          ...
          <div class="tab01 p-b-20">
                ...
                CERTIFICAT EN CUISINE PROFESSIONNEL
                          ...
                          <div >
                              <img width="685" height="400" src="{{URL::asset('public/images/cuisine.jpg')}}">
                          </div>
                           <!--Space-->
            ...
            <div>
              ...
              <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                Ce programme est offert en alternance avec votre activité professionnelle. Il vous permettra de mettre la main à la pâte dès les premiers jours de votre formation. Vous travaillerez dans une véritable cuisine professionnelle faisant partie des installations de pointe.
                Grâce aux professeurs de notre établissement, tous des professionnels chevronnés, vous aborderez chaque aspect du métier, du savoir-être et des relations humaines à la terminologie culinaire, en passant par la salubrité et la science des aliments. Au terme de votre formation, vous aurez acquis toutes les facultés de base et vous serez capable d’intégrer une équipe de professionnels du domaine.
              ...
              <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                  Les cours seront dispensés en soirée de 19h à 21h et ce pendant une durée totale de 110 h.
              </p>
              ...
              <!-- Item post -->
                ...
                <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                Niveau bac ou équivalent. Pour les personnes ne disposant pas du niveau requis, un test d’évaluation sera exigé afin de vérifier leur admissibilité.
                </p>
                <h1 class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;"> <i class="fa fa-arrow-right"></i>
                  <strong>DEBOUCHES :</strong>
                </h1>
                <p class="f1-s-11 cl6 p-b-25" style="text-align: justify;margin-top: auto;">
                   chef cuisinier, traiteur ou restaurateur.
                </p>
